        ...
        >
            ...
            <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-blue-100 transition sm:group-even:pl-8">
                ...
                <ul className="flex flex-wrap mt-5 gap-2 sm:mt-auto">
                    {tags.map((tag, index) => (
                    <li
                        className="bg-black/[0.7] px-3 py-1 text-[0.7rem] uppercase tracking-wider text-white rounded-full group-hover:bg-blue-500"
                        key={index}
                    >
                        {tag}
                    </li>
                ...
                quality={95}
                className="absolute hidden sm:block top-16 -right-52 w-[28.25rem] rounded-t-lg shadow-2xl 
                transition 
