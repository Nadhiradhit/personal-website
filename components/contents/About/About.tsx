    ...
    return (
        <section className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 scroll-mt-28">
            ...
            >
                ...
                <div className="bg-gradient-to-tr from-[#b3f0e8] to-[#ceecfd] absolute top-[-1rem] -z-10 left-[10rem] h-[20.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
            </motion.div>
        </section>
    )
}
