...
export default function Contact() {
	...
	return (
		<section
			ref={ref}
			id="contact"
			className="text-slate-950 z-10 mt-28 max-w-[53rem] w-full scroll-mt-28 sm:mb-40">
			<SectionHeading> Contact Me!</SectionHeading>
			<p className="text-md md:text-xl font-semibold dark:text-slate-50 text-center mb-5">
